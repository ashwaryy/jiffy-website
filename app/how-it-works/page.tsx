      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg border border-slate-100/80 animate-fade-in-up">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <FadeInUp delay={0.1}>
                <div className="space-y-4 text-slate-600 text-lg">
                  <p>
                    Traditional chatbots search through documents piece by piece—a
                    slow and error-prone process known as RAG.
                  </p>
                  <p>
                    <strong className="text-secondary font-semibold">
                      Jiffy is different.
                    </strong>{" "}
                    ICA understands your entire knowledge base contextually. It
                    doesn't just "look up" keywords; it knows the answer.
                  </p>
                </div>
              </FadeInUp>
              ...
              <div className="mt-6 space-y-3">
                {[
                  ...
                  <div
                    key={item}
                    className={`flex items-center gap-3 text-slate-600 animate-fade-in-up animate-delay-${100 + i * 100}`}
                  >
                    <div className="w-6 h-6 rounded-full bg-gradient-to-br from-green-100 to-emerald-100 flex items-center justify-center text-green-600">
            ...
            <FadeInUp delay={0.2}>
              <div className="bg-gradient-to-br from-warm-50 to-amber-50/50 rounded-xl p-8 border border-amber-100/50 flex flex-col items-center justify-center min-h-[350px]">
                <div className="flex items-center gap-8 mb-8 w-full justify-center">
                  <div className="text-center opacity-60 grayscale animate-fade-in-up animate-delay-300">
                    ...
                    <p className="text-xs text-slate-500">
                      Search → Retrieve → Guess
                    </p>
                  </div>

                  <div className="text-xl font-medium text-slate-300 animate-scale-in animate-delay-400">
                    vs
                  </div>

                  <div className="text-center relative animate-fade-in-up animate-delay-500">
                    <div className="absolute -top-3 -right-3 bg-gradient-to-r from-primary to-amber-500 text-white text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wide shadow-sm">
                      New
                    </div>
                    <div className="w-24 h-32 bg-gradient-to-br from-white to-orange-50 border border-orange-200 rounded-xl shadow-lg mx-auto mb-3 flex items-center justify-center">
                      <GiraffeMascot variant="thinking" size={56} />
                    </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={step.num}
                className={`flex flex-col items-center text-center group animate-fade-in-up animate-delay-${150 * i}`}
              >
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <FadeInUp>
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                In education, "close enough" isn't good enough. Students need the
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <Card
              className="bg-red-50/50 border-red-100/80"
              hoverEffect="none"
              delay={0}
            >
              <h3 className="text-red-900 font-bold mb-4 flex items-center gap-2">
                <span className="w-6 h-6 rounded-full bg-red-100 flex items-center justify-center text-red-500 text-sm">
                  ✕
                </span>
                Common Failures
              </h3>
              <ul className="space-y-3 text-red-900/70">
                {[
                  ...
                  <li
                    key={item}
                    className={`flex items-start gap-2 animate-fade-in-up animate-delay-${i * 100}`}
                  >
            ...
            <Card
              className="bg-green-50/50 border-green-100/80"
              hoverEffect="none"
              delay={0.1}
            >
              ...
              <ul className="space-y-3 text-green-900/70">
                {[
                  ...
                  <li
                    key={item}
                    className={`flex items-start gap-2 animate-fade-in-up animate-delay-${100 + i * 100}`}
                  >
