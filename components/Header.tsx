      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <div className="flex-shrink-0 flex items-center gap-2 transition-scale">
            <Link href="/" className="text-2xl font-bold text-secondary tracking-tight flex items-center gap-2">
          ...
          <div className="md:hidden">{/* Simple mobile menu logic would go here */}</div>
        </div>
      </div>
    </header>
  );
